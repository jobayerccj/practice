 ...
 */
final class Version20240726140529 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD COLUMN rating INTEGER DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TEMPORARY TABLE __temp__post AS SELECT id, created_by_id, title, description, created_at, updated_at FROM post');
        ...
        $this->addSql('INSERT INTO post (id, created_by_id, title, description, created_at, updated_at) SELECT id, created_by_id, title, description, created_at, updated_at FROM __temp__post');
